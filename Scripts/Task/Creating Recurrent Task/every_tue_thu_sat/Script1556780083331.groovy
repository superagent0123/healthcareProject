...
WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tm_cbrecurrent_search'), Keys.chord('Every Tuesday, Thursday and Saturday', 
        Keys.ENTER))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_everytths/tb_etths_startson_icon'))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_everytths/tb_etths_startson_today'))

WebUI.setText(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_everytths/tb_etths_endson'), '6302019')
