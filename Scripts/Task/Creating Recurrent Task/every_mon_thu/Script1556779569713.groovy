...
WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tm_cbrecurrent_search'), Keys.chord('Every Monday and Thursday', 
        Keys.ENTER))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_everymth/tb_emth_startson_icon'))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_everymth/tb_emth_startson_today'))

WebUI.setText(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_everymth/tb_emth_endson'), '6302019')
