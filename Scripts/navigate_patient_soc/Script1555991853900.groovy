...
WebUI.navigateToUrl('https://qa.medisource.com')

WebUI.setText(findTestObject('Page_Medisource  Login/input_Please try afterminutes'), 'superagent')

WebUI.delay(1)

WebUI.setEncryptedText(findTestObject('Page_Medisource  Login/input_Username or email requir'), 'SITHpLWAWtI8C4F8RIujvA==')
