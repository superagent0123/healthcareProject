...
not_run: WebUI.navigateToUrl('https://qa.medisource.com/patientcare/D3FB00F5-72C0-4784-9CCF-16AB810BC1D9/9F0C3A42-CF66-4E6A-BC2A-D4D985C667B9/overview')
...
not_run: WebUI.click(findTestObject('Scheduling/addtask/addnewschedule_btn'))
...
'Set date as text\r\n'
WebUI.setText(findTestObject('Scheduling/taskmanager/tm_taskdate'), '0722019')
