...
WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tm_cbrecurrent_search'), Keys.chord('Use Frequency', 
        Keys.ENTER))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_userfreq/tb_userfreq_startson'))

WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_userfreq/tb_userfreq_startson_Tf'), Keys.chord(
        '1st Week', Keys.ENTER))

WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_userfreq/tb_userfreq_frequency'), Keys.chord(
        '1w1', Keys.ENTER))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_userfreq/tb_userfreq_autoplot'))
