...
WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tm_cbrecurrent_search'), Keys.chord('Daily', Keys.ENTER))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_daily/tb_daily_startson_icon'))

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_daily/tb_daily_startson_today'))

WebUI.setText(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_daily/tb_daily_endson'), '6302019')

WebUI.click(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_daily/tb_daily_repeateverydays'))

WebUI.sendKeys(findTestObject('Scheduling/taskmanager/tm_cbrecurrent/tb_recurrent_daily/tb_daily_repeateverydays_tf'), Keys.chord(
        '5', Keys.ENTER))
